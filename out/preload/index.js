...
const api = {
  ...
  cancelDownload: (id) => electron.ipcRenderer.invoke("downloads:cancel", id),
  pauseDownload: (id) => electron.ipcRenderer.invoke("downloads:pause", id),
  resumeDownload: (id) => electron.ipcRenderer.invoke("downloads:resume", id),
