...
const api: PBoxApi = {
  ...
  getUserLinks: () => ipcRenderer.invoke('links:get'),
  setUserLinks: (links) => ipcRenderer.invoke('links:set', links),
  importUserLinks: () => ipcRenderer.invoke('links:import'),
  exportUserLinks: () => ipcRenderer.invoke('links:export'),
