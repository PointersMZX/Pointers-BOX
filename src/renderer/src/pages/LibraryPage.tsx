...
export default function LibraryPage() {
  ...
  return (
    <Flex h="full" minH={0}>
      {/* 左侧分类树 */}
      <Box w="180px" flexShrink={0} borderRightWidth="1px" borderColor="gray.200" p={3} overflowY="auto">
        <Flex
          as="button"
          w="full"
          align="center"
          ...
          <VStack align="stretch" spacing={1} mt={2}>
            {tree.map((node) => (
              <Flex
                ...
                color={category === node.name ? 'white' : 'gray.600'}
                _hover={{ bg: category === node.name ? 'brand.500' : 'gray.100' }}
